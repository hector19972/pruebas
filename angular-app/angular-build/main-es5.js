...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppComponentsRegistroRegistroComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    RegistroComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 41,
      vars: 3,
      consts: [[1, "contact-card"], [1, "example-form", 3, "formGroup", "ngSubmit"], ["f", "ngForm"], [1, "example-full-width", "basic-container"], ["matInput", "", "type", "text", "formControlName", "nombre", "ngModel", "", "required", "", 1, "form-control"], ["matInput", "", "type", "text", "formControlName", "apPaterno", "ngModel", "", "required", "", 1, "form-control"], ["matInput", "", "type", "text", "formControlName", "apMaterno", "ngModel", "", "required", "", 1, "form-control"], ["matInput", "", "type", "text", "formControlName", "correo", "ngModel", "", "required", "", 1, "form-control"], ["matInput", "", "type", "password", "formControlName", "contrase\xF1a", "ngModel", "", "required", "", 1, "form-control", 3, "chang"], ["matInput", "", "type", "password", "formControlName", "contrase\xF1aR", "ngModel", "", "required", "", 1, "form-control", 3, "change"], ["matInput", "", "formControlName", "terminos", "ngModel", "", "required", "", 1, "form-control"], ["class", "mat-error", 4, "ngIf"], [1, "input-group", "col-md-8"], ["mat-raised-button", "", "type", "submit", 1, "btn", "btn-outline-primary", 3, "disabled"], [1, "mat-error"]],
      template: function RegistroComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("chang", function RegistroComponent_Template_input_chang_28_listener() {
            return ctx.cambioss();
          });
